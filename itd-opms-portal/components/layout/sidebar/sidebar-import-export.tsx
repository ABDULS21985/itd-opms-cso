    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          >
            <div className="bg-[#2A1F06] border border-[#A8893D]/20 rounded-2xl shadow-2xl shadow-black/50 overflow-hidden">
              {/* Header */}
              <div className="flex items-center justify-between px-5 py-4 border-b border-[#A8893D]/15">
              ...
              <div className="p-5 space-y-4">
                ...
                <button
                  ...
                  className="w-full flex items-center gap-3 px-4 py-3 rounded-xl bg-white/5 border border-[#A8893D]/15 text-white hover:bg-white/10 transition-colors"
                >
                  <Download
                    size={18}
                ...
                {preview && (
                  <motion.div
                    ...
                    className="rounded-xl bg-white/5 border border-[#A8893D]/20 p-4 space-y-3"
                  >
                    <div className="flex items-center gap-2 text-sm font-medium text-white">
                      <FileJson size={16} className="text-[#C4A962]" />
                      Preview
                    </div>
                    ...
                    <button
                      ...
                      className="w-full py-2 rounded-lg bg-[#A8893D]/20 text-[#C4A962] text-sm font-medium hover:bg-[#A8893D]/30 transition-colors"
                    >
                      Apply Layout
                    </button>
                  </motion.div>
