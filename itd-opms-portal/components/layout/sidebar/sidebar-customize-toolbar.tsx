    ...
    >
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-2">
          <Pencil size={12} className="text-[#2D9B58]" />
          <span className="text-xs font-semibold text-[#2D9B58]">
            Customizing...
          </span>
          {totalHiddenCount > 0 && (
            <span className="text-[10px] bg-[#1B7340]/20 text-[#2D9B58] px-1.5 py-0.5 rounded-full">
