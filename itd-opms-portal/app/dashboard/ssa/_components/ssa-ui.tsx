...
export function SSAStatCard({
  ...
  return (
    <div className="group relative overflow-hidden rounded-[1.45rem] border border-[var(--border)] bg-[var(--surface-0)] p-5 shadow-[0_18px_35px_rgba(15,23,42,0.05)] backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_24px_45px_rgba(15,23,42,0.08)]">
      <div
...
export function SSASectionCard({
  ...
  return (
    <section
      className={`overflow-hidden rounded-[1.8rem] border border-[var(--border)] bg-[var(--surface-0)] p-6 shadow-[0_18px_40px_rgba(15,23,42,0.05)] ${className}`}
    >
