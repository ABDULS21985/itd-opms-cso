...
const STEPS = [
  { label: "Details", icon: GitBranch, description: "Matrix information" },
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6 pb-12">
      ...
      >
        <button
          type="button"
          onClick={() => router.push("/dashboard/governance/raci")}
            ...
            {step === 0 && (
              <div>
                ...
                <p className="text-sm text-[var(--neutral-gray)] mb-5">
                  Provide the basic information for this RACI matrix.
                </p>
      ...
      >
        <button
          ...
          onClick={
            step === 0
              ? () => router.push("/dashboard/governance/raci")
              : goPrev
          }
        ...
        {isLastStep ? (
          <button
            ...
            disabled={createMutation.isPending || !title.trim() || !entityType}
