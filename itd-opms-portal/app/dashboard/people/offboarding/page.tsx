...
import type { PeopleChecklist, ChecklistTask } from "@/types";
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-[var(--text-secondary)]">
              Track offboarding tasks, access revocation, and handovers
            </p>
          </div>
        </div>
      ...
      >
        {isLoading ? (
          ...
          <div className="rounded-xl border border-[var(--border)] bg-[var(--surface-0)] p-12 text-center">
            <UserMinus size={24} className="mx-auto text-[var(--text-secondary)] mb-2" />
            <p className="text-sm font-medium text-[var(--text-primary)]">
              No offboarding checklists found
            </p>
            <p className="text-xs text-[var(--text-secondary)] mt-1">
              Start an offboarding process when a team member is departing.
            </p>
          </div>
        ) : (
