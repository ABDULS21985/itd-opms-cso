...
const PAGE_COMMANDS: CommandItem[] = [
  { id: "dashboard", label: "Dashboard", description: "Overview & metrics", icon: LayoutDashboard, category: "page", href: "/admin", shortcut: "G D" },
  { id: "candidates", label: "Candidates", description: "Manage candidate profiles", icon: Users, category: "page", href: "/admin/candidates", shortcut: "G C" },
  { id: "employers", label: "Employers", description: "Employer verification queue", icon: Building2, category: "page", href: "/admin/employers" },
  { id: "jobs", label: "Jobs", description: "Job moderation & management", icon: Briefcase, category: "page", href: "/admin/jobs", shortcut: "G J" },
  { id: "intro-requests", label: "Intro Requests", description: "Review introductions", icon: Mail, category: "page", href: "/admin/intro-requests" },
  { id: "placements", label: "Placements", description: "Placement tracking", icon: TrendingUp, category: "page", href: "/admin/placements", shortcut: "G P" },
  { id: "reports", label: "Reports", description: "Analytics & reporting", icon: BarChart3, category: "page", href: "/admin/reports" },
  { id: "taxonomy", label: "Taxonomy", description: "Skills, tracks, cohorts", icon: Tags, category: "page", href: "/admin/taxonomy" },
  { id: "audit-logs", label: "Audit Logs", description: "System activity logs", icon: ScrollText, category: "page", href: "/admin/audit-logs" },
  { id: "settings", label: "Settings", description: "Admin settings", icon: Settings, category: "page", href: "/admin/settings", shortcut: "G S" },
  { id: "users", label: "Users", description: "User management & roles", icon: Users, category: "page", href: "/admin/users" },
];

const ACTION_COMMANDS: CommandItem[] = [
  { id: "create-placement", label: "Create Placement", description: "Start a new placement record", icon: Plus, category: "action", href: "/admin/placements/new" },
  { id: "import-candidates", label: "Import Candidates", description: "Bulk import candidate data", icon: FileText, category: "action", href: "/admin/candidates/import" },
];
        ...
        {items.map((item, i) => {
          ...
          return (
            ...
            >
              <Icon
                size={18}
                className={isSelected ? "text-[var(--primary)]" : "text-[var(--neutral-gray)]"}
              />
              ...
              {isSelected && (
                <ArrowRight size={14} className="text-[var(--primary)] flex-shrink-0" />
              )}
            </button>
          );
        })}
    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          >
            <div className="bg-[var(--surface-1)] border border-[var(--border)] shadow-2xl rounded-2xl overflow-hidden" role="dialog" aria-label="Command palette">
              {/* Search input */}
              <div className="flex items-center gap-3 px-4 py-3 border-b border-[var(--border)]">
                ...
                <input
                  ...
                  className="flex-1 text-sm bg-transparent outline-none placeholder:text-[var(--neutral-gray)]"
                />
              ...
              <div className="flex items-center gap-4 px-4 py-2.5 border-t border-[var(--border)] bg-[var(--surface-1)]">
                <span className="flex items-center gap-1.5 text-[11px] text-[var(--neutral-gray)]">
                  <kbd className="px-1 py-0.5 text-[10px] font-mono bg-[var(--surface-1)] border border-[var(--border)] rounded">↑↓</kbd>
                  Navigate
                </span>
                <span className="flex items-center gap-1.5 text-[11px] text-[var(--neutral-gray)]">
                  <kbd className="px-1 py-0.5 text-[10px] font-mono bg-[var(--surface-1)] border border-[var(--border)] rounded">↵</kbd>
                ...
                <span className="flex items-center gap-1.5 text-[11px] text-[var(--neutral-gray)]">
                  <kbd className="px-1 py-0.5 text-[10px] font-mono bg-[var(--surface-1)] border border-[var(--border)] rounded">esc</kbd>
                  Close
                </span>
              </div>
            </div>
