...
const MORE_ITEMS: MoreNavItem[] = [
  { href: "/employer/candidates", label: "Discover Talent", icon: Users, description: "Search candidates" },
  { href: "/employer/intro-requests", label: "Intro Requests", icon: Mail, description: "Incoming requests" },
  { href: "/employer/analytics", label: "Analytics", icon: BarChart3, description: "Insights & performance" },
  { href: "/employer/team", label: "Team", icon: UserPlus, description: "Members & roles" },
  { href: "/employer/settings", label: "Settings", icon: Settings, description: "Security & preferences" },
];
...
export function EmployerMobileNav() {
  ...
  return (
    <>
      ...
      <nav
        className="fixed bottom-0 left-0 right-0 z-40 lg:hidden bg-[var(--surface-0)] border-t border-[var(--border)] pb-[env(safe-area-inset-bottom)]"
        ...
        {moreOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed bottom-0 left-0 right-0 z-50 bg-[var(--surface-0)] rounded-t-2xl px-4 pb-[env(safe-area-inset-bottom)] lg:hidden"
            >
