...
const MORE_ITEMS: MoreNavItem[] = [
  { href: "/admin/employers", label: "Employers", icon: Building2, description: "Employer verification" },
  { href: "/admin/intro-requests", label: "Intro Requests", icon: Mail, description: "Review introductions" },
  { href: "/admin/reports", label: "Reports", icon: BarChart3, description: "Analytics & reporting" },
  { href: "/admin/users", label: "Users", icon: Users, description: "User management" },
  { href: "/admin/taxonomy", label: "Taxonomy", icon: Tags, description: "Skills, tracks, cohorts" },
  { href: "/admin/audit-logs", label: "Audit Logs", icon: ScrollText, description: "System activity logs" },
  { href: "/admin/settings", label: "Settings", icon: Settings, description: "Admin settings" },
];
...
export function AdminMobileNav({ badgeCounts = {} }: AdminMobileNavProps) {
